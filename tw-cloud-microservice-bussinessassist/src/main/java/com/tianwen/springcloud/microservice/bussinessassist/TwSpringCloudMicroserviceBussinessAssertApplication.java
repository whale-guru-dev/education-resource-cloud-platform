package com.tianwen.springcloud.microservice.bussinessassist;
...
public class TwSpringCloudMicroserviceBussinessAssertApplication
{
    public static void main(String[] args)
    {
        System.out.println("TwSpringCloudMicroserviceBussinessAssertApplication before");

        BasicConfigurator.configure();
        SpringApplication.run(TwSpringCloudMicroserviceBussinessAssertApplication.class, args);

        System.out.println("TwSpringCloudMicroserviceBussinessAssertApplication after");
    }
}
