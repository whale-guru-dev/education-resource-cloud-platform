package com.tianwen.springcloud.microservice.question;
...
public class TwSpringCloudMicroserviceQuestionApplication
{
    public static void main(String[] args)
    {
        System.out.println("TwSpringCloudMicroserviceQuestionApplication before");

        BasicConfigurator.configure();
        SpringApplication.run(TwSpringCloudMicroserviceQuestionApplication.class, args);

        System.out.println("TwSpringCloudMicroserviceQuestionApplication after");
    }
}
