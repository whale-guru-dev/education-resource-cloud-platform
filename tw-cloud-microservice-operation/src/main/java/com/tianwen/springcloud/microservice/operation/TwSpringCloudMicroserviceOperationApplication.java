package com.tianwen.springcloud.microservice.operation;
...
public class TwSpringCloudMicroserviceOperationApplication
{
    public static void main(String[] args)
    {
        System.out.println("TwSpringCloudMicroserviceOperationApplication before");

        BasicConfigurator.configure();
        SpringApplication.run(TwSpringCloudMicroserviceOperationApplication.class, args);

        System.out.println("TwSpringCloudMicroserviceOperationApplication after");
    }
}
